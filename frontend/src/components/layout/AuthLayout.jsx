...
export default function AuthLayout() {
  return (
    <div className="flex items-center justify-center w-full min-h-screen overflow-hidden font-JosefinSans dark:bg-gradient-to-tl dark:from-indigo-900/95 dark:via-gray-800 dark:to-gray-900 bg-gradient-to-tr from-blue-200 via-gray-100/95 to-gray-200">
